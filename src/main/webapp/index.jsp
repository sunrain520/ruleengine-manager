...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			<ul id="nav-top" class="nav navbar-nav navbar-left">
			</ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                       ...
                       <ul class="nav nav-tabs" id="tabs-ul">
                           <li class="active" id="home-tab-head"><a href="#home" data-toggle="tab">Home</a>
                           </li>
                       </ul>

                       <!-- Tab panes -->
                       <div class="tab-content" id="tabs-div">
                           <div class="tab-pane fade in active" id="home-tab-body">
                               你好啊，肥嘎。!
                           </div>
                       </div>
                </div>
    ...
    <script src="js/ruleengine/index.js"></script>
</body>
</html>
