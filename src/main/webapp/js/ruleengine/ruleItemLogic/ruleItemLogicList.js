var paramFactory = {
	...
	getQueryCondition : function(data) {
		...
		param.ruleExpression = $("#rule-expression-search").val();
...
$(function () {
    var _table = $('#dataTables-example').DataTable($.extend(true,{},CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
        ...
        createdRow: function ( row, data, index ) {
        	...
        	var param = {};
        	param.id = data.fAutoId;
        	makeRowOperation(row, 3, 'ruleItemLogic/check', 'ruleItemLogic/update', param);
        },
    }));
    ...
    var paramW = {};
    makeTable('ruleItemLogic/check', 'ruleItemLogic/insert', paramW);
    initSearchArea();
    bindModalEvent();
});